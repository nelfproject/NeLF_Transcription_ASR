...
class Speech2TextAndSubs:
    ...
    def __init__(
        ...
        if not hasattr(asr_model, 'task_labels_v2'):
            self.task_labels_v2 = False
        else:
            self.task_labels_v2 = asr_model.task_labels_v2
        ...
        if self.decoder_mlm:
            ...
            beam_search = BeamSearch(
                ...
                task_labels_v2=self.task_labels_v2,
            )
        ...
        if not hasattr(asr_model, 'fix_conditioning'):
            self.fix_conditioning = False
        else:
            self.fix_conditioning = asr_model.fix_conditioning
    ...
    with DatadirWriter(output_dir) as writer:
        for keys, batch in loader:
            ...
            try:
                ...
                results_asr = [[" ", ["<space>"], [2], hyp]] * nbest
                results_subs = [[" ", ["<space>"], [2], hyp]] * nbest
                results = list(zip(results_asr, results_subs))
