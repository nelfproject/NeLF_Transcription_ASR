...
if [[ -f ${srcdir}/text.lc.subtitle ]]; then
    utils/apply_map.pl -f 1 "${destdir}"/utt_map <"${srcdir}"/text.lc.subtitle >"${destdir}"/text.lc.subtitle
fi
if [[ -f ${srcdir}/text.lc.verbatim ]]; then
    utils/apply_map.pl -f 1 "${destdir}"/utt_map <"${srcdir}"/text.lc.verbatim >"${destdir}"/text.lc.verbatim
fi
